    ...
    25250: function (e, t, n) {
      ...
      let j = l.default.forwardRef(function (e, t) {
        ...
        let I = l.default.useContext(s.RouterContext),
          ...
          { href: D, as: N } = l.default.useMemo(() => {
            if (!I) {
              let e = _(a);
              return { href: e, as: v ? _(v) : e };
            }
            let [e, t] = (0, u.resolveHref)(I, a, !0);
            return { href: e, as: v ? (0, u.resolveHref)(I, v) : t || e };
          }, [I, a, v]),
          H = l.default.useRef(D),
          q = l.default.useRef(N);
        w && (r = l.default.Children.only(n));
        let z = w ? r && "object" == typeof r && r.ref : t,
          [B, F, G] = (0, p.useIntersection)({ rootMargin: "200px" }),
          J = l.default.useCallback(
            (e) => {
              (q.current !== N || H.current !== D) &&
                (G(), (q.current = N), (H.current = D)),
                B(e),
                z &&
                  ("function" == typeof z
                    ? z(e)
        ...
        l.default.useEffect(() => {
          S && F && K && g(S, D, N, { locale: O }, { kind: A }, U);
        ...
        if ((0, i.isAbsoluteUrl)(N)) Q.href = N;
          ...
          Q.href =
            t ||
            (0, b.addBasePath)(
              (0, c.addLocale)(N, e, null == I ? void 0 : I.defaultLocale)
            );
        }
        return w
          ? l.default.cloneElement(r, Q)
          : (0, o.jsx)("a", { ...R, ...Q, children: n });
      });
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
